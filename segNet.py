...
def net(image, classes):
    ...
    # encoding level 1
    e1_c1 = util.conv(image, [f,f,3,256], "e1_c1")
    e1_c2 = util.conv(e1_c1, [f,f,256,256], "e1_c2")
    pool1, pool1_indices = util.pool(e1_c2, 2, 2, poolIndices=True, name="pool1")

    # encoding level 2
    e2_c1 = util.conv(pool1, [f,f,256,256], "e2_c1")
    e2_c2 = util.conv(e2_c1, [f,f,256,256], "e2_c2")
    pool2, pool2_indices = util.pool(e2_c2, 2, 2, poolIndices=True, name="pool2")
    
    # encoding level 3
    e3_c1 = util.conv(pool2, [f,f,256,256], "e3_c1")
    e3_c2 = util.conv(e3_c1, [f,f,256,256], "e3_c2")
    e3_c3 = util.conv(e3_c2, [f,f,256,256], "e3_c3")
    pool3, pool3_indices = util.pool(e3_c3, 2, 2, poolIndices=True, name="pool3")

    # encoding level 4
    e4_c1 = util.conv(pool3, [f,f,256,256], "e4_c1")
    e4_c2 = util.conv(e4_c1, [f,f,256,256], "e4_c2")
    e4_c3 = util.conv(e4_c2, [f,f,256,256], "e4_c3")
    pool4, pool4_indices = util.pool(e4_c3, 2, 2, poolIndices=True, name="pool4")

    # encoding level 5
    e5_c1 = util.conv(pool4, [f,f,256,256], "e5_c1")
    e5_c2 = util.conv(e5_c1, [f,f,256,256], "e5_c2")
    e5_c3 = util.conv(e5_c2, [f,f,256,256], "e5_c3")
    ...
    de1_c1 = util.conv(upSam5, [f,f,256,256], "de1_c1")
    de1_c2 = util.conv(de1_c1, [f,f,256,256], "de1_c2")
    
    # dencoding level 2
    upSam4 = unpool_layer2x2(pool4, pool4_indices, pool3.get_shape())
    de2_c1 = util.conv(upSam4, [f,f,256,256], "de2_c1")
    de2_c2 = util.conv(de2_c1, [f,f,256,256], "de2_c2")
    
    # decoding level 3
    upSam3 = unpool_layer2x2(pool3, pool3_indices, pool2.get_shape())
    de3_c1 = util.conv(upSam3, [f,f,256,256], "de3_c1")
    de3_c2 = util.conv(de3_c1, [f,f,256,256], "de3_c2")
    de3_c2 = util.conv(de3_c2, [f,f,256,256], "de3_c3")
    
    # decoding level 4
    upSam2 = unpool_layer2x2(pool2, pool2_indices, pool1.get_shape())
    de4_c1 = util.conv(upSam2, [f,f,256,256], "de4_c1")
    de4_c2 = util.conv(de4_c1, [f,f,256,256], "de4_c2")
    de4_c3 = util.conv(de4_c2, [f,f,256,256], "de4_c3")
    
    # decoding level 5
    upSam1 = unpool_layer2x2(pool1, pool1_indices, e1_c1.get_shape())
    de5_c1 = util.conv(upSam1, [f,f,256,256], "de5_c1")
    de5_c2 = util.conv(de5_c1, [f,f,256,256], "de5_c2")
    de5_c3 = util.conv(de5_c2, [f,f,256,256], "de5_c3")
    
    softmax = tf.nn.softmax(de5_c3)

    return de5_c3, tf.argmax(softmax, axis=3)
