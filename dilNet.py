# dilated convolutional NN according to:
...
def net(image, classes):
    ...
    e4_c1 = util.conv(e3_c3, [K, K, 256, 512], "e4_c1", dilation=2)
    ...
    e5_c3 = util.conv(e5_c2, [1, 1, 512, 128], "e5_c3", dilation=4)

    de1 = util.deconv(e5_c3, tf.shape(e2_c2), [K,K,128,128], "de1")
    de2 = util.deconv(de1, tf.shape(e1_c2), [K,K,64,128], "de2")

    final = util.conv(de2, [K,K,64,classes], "final")
