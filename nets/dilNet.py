...
def net(image, classes):
    ...
    e1_c1 = util.conv(image, [K, K, 3, 128], "e1_c1")
    e1_c2 = util.conv(e1_c1, [K, K, 128, 128], "e1_c2")
    pool1 = util.pool(e1_c1, 2, STRIDE, name="pool1")

    e2_c1 = util.conv(pool1, [K, K, 128, 512], "e2_c1")
    e2_c2 = util.conv(e2_c1, [K, K, 512, 512], "e2_c2")
    pool2 = util.pool(e2_c2, 2, STRIDE, name="pool2")

    e3_c1 = util.conv(pool2, [K, K, 512, 512], "e3_c1")
    e3_c2 = util.conv(e3_c1, [K, K, 512, 512], "e3_c2")
    e3_c3 = util.conv(e3_c2, [1, 1, 512, 512], "e3_c3")

    e4_c1 = util.conv(e3_c3, [K, K, 512, 1024], "e4_c1", dilation=2)
    e4_c2 = util.conv(e4_c1, [K, K, 1024, 1024], "e4_c2", dilation=2)
    e4_c3 = util.conv(e4_c2, [1, 1, 1024, 1024], "e4_c3", dilation=2)
    
    e5_c1 = util.conv(e4_c3, [K, K, 1024, 1024], "e5_c1", dilation=4)
    e5_c2 = util.conv(e5_c1, [K, K, 1024, 1024], "e5_c2", dilation=4)
    e5_c3 = util.conv(e5_c2, [1, 1, 1024, 1024], "e5_c3", dilation=4)

    de1 = util.deconv(e5_c3, tf.shape(e2_c2), [K,K,512,1024], "de1")
    de2 = util.deconv(de1, tf.shape(e1_c2), [K,K,128,512], "de2")

    final = util.conv(de2, [K,K,128,classes], "final")
